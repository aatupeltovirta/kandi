...
# Read the file
data = np.genfromtxt(r'C:\Users\atubb\kandi\EXP2016.dat', delimiter=',', skip_header=1, usecols=(4, 3, 7, 2))
...
final_binding_energy = y_val * AA
final_predicted_be = predicted_be * AA
