...
# Read the file
data = np.genfromtxt(r'C:\Users\atubb\kandi\EXP2020.dat', delimiter=',', skip_header=1, usecols=(4, 3, 7, 2, 9))

#data = np.genfromtxt(r'/home/aajamape/kandi/EXP2020.dat', delimiter=',', skip_header=1, usecols=(4, 3, 7))
